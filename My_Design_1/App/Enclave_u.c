...
sgx_status_t ecall_computeKNN(sgx_enclave_id_t eid, int* result, double* A, double* B, double* C, size_t DB_size, size_t n, size_t W_size, size_t k)
{
	sgx_status_t status;
	ms_ecall_computeKNN_t ms;
	ms.ms_result = result;
	ms.ms_A = A;
	ms.ms_B = B;
	ms.ms_C = C;
	ms.ms_DB_size = DB_size;
	ms.ms_n = n;
	ms.ms_W_size = W_size;
	ms.ms_k = k;
